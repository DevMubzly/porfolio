...
export function ProjectsSection() {
  return (
    <section id="projects" className="sticky top-0 z-[3] py-24 lg:py-32 px-6 lg:px-24 bg-[#F8F8F8] text-[#222222] rounded-t-[3rem] lg:rounded-t-[4rem] shadow-[0_-4px_24px_rgba(0,0,0,0.03)] flex flex-col justify-center transition-colors duration-300">
