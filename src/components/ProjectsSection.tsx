              ...
              <div className="p-6 md:p-8 space-y-6 md:space-y-8 overflow-y-auto max-h-[64vh]">
                <div className="flex flex-col md:flex-row md:items-start md:justify-between gap-4 md:gap-6">
                  <div>
                    ...
                    {active.status && (
                      <p className="mt-1 text-[11px] uppercase tracking-[0.18em] text-neutral-500">{active.status}</p>
                    )}
                  </div>
                  {active.projectURL && (
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="inline-flex items-center justify-center rounded-full px-4 py-2 text-xs font-medium tracking-wide bg-neutral-900 text-white hover:bg-black focus-ring cursor-pointer"
                    >
                      View live / repo
                    </a>
                  )}
                ...
                <div className="grid md:grid-cols-[minmax(0,2.2fr)_minmax(0,1fr)] gap-6 md:gap-8 items-start">
                  <p
                    ...
                    className="text-sm md:text-[15px] text-neutral-700 leading-relaxed whitespace-pre-line"
                  >
                    ...
                    <div>
                      ...
                      <ul className="flex flex-wrap gap-2">
                        {active.stack.map(s => (
                          <li
                            key={s}
                            className="px-2.5 py-1.5 rounded-md bg-neutral-200 text-[11px] font-medium tracking-wide text-neutral-800 shadow-inner"
                          >
                            {s}
                          </li>
                        ))}
                          ...
                          {active.links.map(l => (
                            <li key={l.href}>
                              <a
                                ...
                                target="_blank"
                                rel="noopener noreferrer"
                                className="text-neutral-700 hover:text-black underline decoration-neutral-400/70 hover:decoration-neutral-800 transition-colors"
                              >
                                {l.label}
                              </a>
                            </li>
                ...
                <div className="pt-2 flex justify-end">
                  <button
                    onClick={closeModal}
                    className="px-4 cursor-pointer py-2 rounded-lg bg-neutral-900 text-white text-xs font-medium tracking-wide hover:bg-black focus-ring transition-colors"
                  >
                    Close
                  </button>
                </div>
